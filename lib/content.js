...
function defaults() {
  return {
    theme: "classic", // classic | apple | aurora
    branding: {
      useCustom: false,
      primary: "#015843",
      accent: "#eb6435",
...
function mergeDefaults(content) {
  ...
  for (const key of ["branding", "site", "hero", "carouselSettings", "about", "quoteForm", "email", "i18n", "bookingSettings", "decorations", "effects", "quoteCalc"]) {
  ...
  // asegurar arrays
  for (const key of ["services", "testimonials", "beforeAfter", "plans", "clients", "posts", "videos", "carousel", "users", "auditLog", "bookings", "faqs", "discounts"]) {
